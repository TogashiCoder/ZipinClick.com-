             ...
             <div class="row gy-5">
                 ...
                 <div class="col-xl-2 col-sm-6 col-xs-6">
                     <div class="footer-widget">
                         ...
                         <ul class="footer-lists">
                             <li class="footer-lists__item"><a href="all-product.html" class="footer-lists__link">Product
                                 </a></li>
                 ...
                 <div class="col-xl-3 col-sm-6 col-xs-6 ps-xl-5">
                     <div class="footer-widget">
                         ...
                         <ul class="footer-lists">
                             <li class="footer-lists__item"><a href="dashboard.html" class="footer-lists__link">Dashboard
                                 </a></li>
                 ...
                 <div class="col-xl-4 col-sm-6">
                     <div class="footer_widget_count">
                         ...
                         <div class="img">
                             <img src="frontend/assets/images/thumbs/pay_brand.png" alt="Payment" class="img-fluid w-100">
                         </div>
                     </div>
                 </div>
             </div>
